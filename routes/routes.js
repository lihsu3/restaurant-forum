...
router.get('/restaurants/top', authenticated, restController.getTopRestaurant)//place before 'GET /restaurants/:id'
...
router.get('/users/top', authenticated, userController.getTopUser)//place before 'GET /users/:id'
